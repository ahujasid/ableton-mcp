                ...
                def main_thread_task():
                    try:
                        ...
                        if command_type == "create_midi_track":
                            ...
                            track_index = params.get("track_index", 0)
                            device_index = params.get("device_index", 0)
                            result = self._get_device_params(track_index, device_index)
                        elif command_type == "set_device_param":
                            track_index = params.get("track_index", 0)
                            device_index = params.get("device_index", 0)
                            param = params.get("param", "")
                            value = params.get("value", 0.0)
                            result = self._set_device_param(track_index, device_index, param, value)
                            ...
                            track_index = params.get("track_index", 0)
                            device_index = params.get("device_index", 0)
                            result = self._get_device_chains(track_index, device_index)
                        elif command_type == "set_chain_volume":
                            track_index = params.get("track_index", 0)
                            device_index = params.get("device_index", 0)
                            chain_index = params.get("chain_index", 0)
                            value = params.get("value", 0.85)
                            result = self._set_chain_volume(track_index, device_index, chain_index, value)
