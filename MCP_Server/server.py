...
def get_session_info(ctx: Context) -> str:
    ...
    try:
        ...
        return format_error("Failed to get session info", detail=str(e),
...
def get_track_info(ctx: Context, track_index: int) -> str:
    ...
    try:
        ...
        return format_error("Failed to get track info", detail=str(e),
                           suggestion="Check track index with get_session_info first")
...
def create_midi_track(ctx: Context, index: int = -1) -> str:
    ...
    try:
        ...
        return format_error("Failed to create MIDI track", detail=str(e),
...
def set_track_name(ctx: Context, track_index: int, name: str) -> str:
    ...
    try:
        ...
        return format_error("Failed to set track name", detail=str(e),
                           suggestion="Verify track index with get_session_info")
...
def create_clip(ctx: Context, track_index: int, clip_index: int, length: float = 4.0) -> str:
    ...
    try:
        ...
        return format_error("Failed to create clip", detail=str(e),
                           suggestion="Verify track and clip slot indices with get_track_info")
...
def add_notes_to_clip(
    ...
    try:
        ...
        return format_error("Failed to add notes to clip", detail=str(e),
                           suggestion="Ensure clip exists at the specified track and slot")
...
def set_clip_name(ctx: Context, track_index: int, clip_index: int, name: str) -> str:
    ...
    try:
        ...
        return format_error("Failed to set clip name", detail=str(e),
                           suggestion="Ensure clip exists at the specified track and slot")
...
def set_tempo(ctx: Context, tempo: float) -> str:
    ...
    try:
        ...
        return format_error("Failed to set tempo", detail=str(e),
...
def load_instrument_or_effect(ctx: Context, track_index: int, uri: str) -> str:
    ...
    try:
        ...
        if result.get("loaded", False):
            ...
            chain_str = ", ".join(device_chain) if device_chain else "none"
            return (
                f"Loaded '{item_name}' on track {track_index} "
                f"(device chain: {chain_str})"
            )
        else:
            return format_error(
...
def fire_clip(ctx: Context, track_index: int, clip_index: int) -> str:
    ...
    try:
        ...
        return format_error("Failed to fire clip", detail=str(e),
                           suggestion="Ensure clip exists at the specified track and slot")
...
def stop_clip(ctx: Context, track_index: int, clip_index: int) -> str:
    ...
    try:
        ...
        return format_error("Failed to stop clip", detail=str(e),
                           suggestion="Ensure clip exists at the specified track and slot")
...
def start_playback(ctx: Context) -> str:
    ...
    try:
        ...
        return format_error("Failed to start playback", detail=str(e),
...
def stop_playback(ctx: Context) -> str:
    ...
    try:
        ...
        return format_error("Failed to stop playback", detail=str(e),
                           suggestion="Verify connection with get_connection_status")
...
def get_browser_tree(ctx: Context, category_type: str = "all") -> str:
    ...
    try:
        ...
        if "Browser is not available" in error_msg:
            return format_error("Browser is not available",
                               detail=error_msg,
                               suggestion="Make sure Ableton Live is fully loaded and try again")
        elif "Could not access Live application" in error_msg:
            return format_error("Could not access Live application",
                               detail=error_msg,
                               suggestion="Ensure Ableton is running and Remote Script is loaded")
        else:
            return format_error("Failed to get browser tree", detail=error_msg,
                               suggestion="Verify connection with get_connection_status")
...
def get_browser_items_at_path(ctx: Context, path: str) -> str:
    ...
    try:
        ...
        if "Browser is not available" in error_msg:
            ...
            return format_error("Invalid browser category",
                               detail=error_msg,
                               suggestion="Check available categories using get_browser_tree")
        elif "Path part" in error_msg and "not found" in error_msg:
            return format_error("Path not found",
                               detail=error_msg,
                               suggestion="Check the path and try again")
        else:
            return format_error("Failed to get browser items", detail=error_msg,
                               suggestion="Verify the path format: category/folder/subfolder")
...
def load_drum_kit(ctx: Context, track_index: int, rack_uri: str, kit_path: str) -> str:
    ...
    try:
        ...
        return format_error("Failed to load drum kit", detail=str(e),
                           suggestion="Verify URIs using get_browser_items_at_path first")
